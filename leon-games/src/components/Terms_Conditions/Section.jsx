...
// Map icon keys to components dynamically
const sectionIcons = {
  1: FiFileText,
  2: FiMapPin,
  3: FiUserCheck,
...
export default function TermsSection({ section }) {
  ...
  return (
    ...
    >
      {/* Decorative vertical glowing green accent indicator */}
      ...
      <div className="flex flex-col md:flex-row items-start gap-6">
        {/* Section Icon & Numeric Indicator */}
        ...
        <div className="flex-1 space-y-6">
          ...
          {/* Render explicit contact credentials if in last section */}
          {section.contactDetails && (
            <div className="mt-6 p-6 rounded-xl bg-[#00C853]/5 border border-[#00C853]/10 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <span className="text-[10px] font-bold tracking-widest text-zinc-500 uppercase">Support Email</span>
                <p className="text-sm text-white font-mono mt-0.5">{section.contactDetails.email}</p>
              </div>
              <div>
                <span className="text-[10px] font-bold tracking-widest text-zinc-500 uppercase">Phone Contact</span>
                <p className="text-sm text-white font-mono mt-0.5">{section.contactDetails.phone}</p>
              </div>
              <div>
                <span className="text-[10px] font-bold tracking-widest text-zinc-500 uppercase">Business Office Location</span>
                <p className="text-sm text-white mt-0.5">{section.contactDetails.address}</p>
              </div>
              <div>
                <span className="text-[10px] font-bold tracking-widest text-zinc-500 uppercase">Platform URL</span>
