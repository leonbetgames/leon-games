...
export default function SupportIllustration() {
  ...
  return (
    <div
      ...
      className="w-full max-w-[460px] mx-auto cursor-move select-none"
      style={{
        transform: `translate(${offset.x}px, ${offset.y}px)`,
        transition: 'transform 0.2s ease-out',
      }}
    >
      <svg className="w-full h-auto drop-shadow-[0_15px_40px_rgba(0,200,83,0.12)]" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
